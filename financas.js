...
function ModalLancamento({ lancamento, tipoInicial, categorias, contas, contaPadraoId, cartoes, limiar5Dias, valorInicial, documentoId, lancamentos, onSalvar, onAdiar5Dias, onRemover, onAnexarDocumento, onEditarNoMercado, onFechar }) {
  useFecharComVoltar(true, onFechar);
...
function TelaExtrato({ categorias, contas, lancamentos, documentos, onSalvarLancamento, onRemoverLancamento, lancamentosFixos, setLancamentosFixos, lembretes5Dias, limiar5Dias, onAdiar5Dias, onConfirmarLembrete, onDescartarLembrete, reflexoesMensais, onSalvarReflexao, metas, cartoes, gruposOrcamento, rendaManual, onResolverPendente, onAnexarDocumento, onFotografarRecibo, onEditarNoMercado, onAbrirConfig }) {
...
function AppFinancas({ apiKey, setApiKey, onVoltarHub, onEditarNoMercado }) {
